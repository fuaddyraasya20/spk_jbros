...
<html>
    ...
    <body>
        <div class="main">        
            ...
            <h3 style="padding-bottom: 15px;">Tentang Sistem Penunjang Keputusan Metode <span style='color:red;'><i>Simple Additive Weighting</i></span></h3>
            <table style="padding-bottom: 25px;">
                    <tr>
                     ...
                     <?php
                        $sql = mysql_query("select * from tb_tentang where id_judul='sistem'");
                        {
