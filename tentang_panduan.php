...
<html>
    ...
    <body>
        <div class="main">        
            ...
            <h3 style="padding-bottom: 15px;"><span style='color:red;'>Panduan</span> Penggunaan Aplikasi Sistem Pendukung Keputusan Metode <i>Simple Additive Weighting</i></h3>
            <table style="padding-bottom: 25px;">
                    <tr>
                     ...
                     <?php
                        $sql = mysql_query("select * from tb_tentang where id_judul='panduan'");
                        {
